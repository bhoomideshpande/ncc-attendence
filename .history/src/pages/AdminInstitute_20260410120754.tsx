...
const AdminInstitute: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch institute
        const instituteResponse = await instituteService.getById(slug);
        setInstitute(instituteResponse.data);
        
        // Fetch students for this institute
        const studentsResponse = await studentService.getByInstitute(slug);
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 pt-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              ...
              <p className="text-sm opacity-80">{institute.battalion || institute.city}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 -mt-10 pb-12 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Parades</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Total Cadets</CardTitle>
            </CardHeader>
            <CardContent>
