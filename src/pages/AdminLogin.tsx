    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary/75 to-secondary p-4">
      ...
      <Card className="w-full max-w-md relative rounded-2xl shadow-2xl border border-orange-300/50">
        ...
        <div className="absolute top-[-35px] left-1/2 -translate-x-1/2">
          <div className="w-28 h-28 bg-orange-500 rounded-full flex items-center justify-center shadow-lg 
        ...
        <CardHeader className="pt-20 text-center space-y-2">
          <CardTitle className="text-3xl font-bold text-orange-600 tracking-wide animate-fade-in">
            Admin Portal
          </CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button 
              type="submit"
              disabled={loading}
              className="w-full bg-orange-500 hover:bg-orange-600 text-white py-6 rounded-xl text-lg font-semibold transition-all shadow-md hover:shadow-xl"
            >
